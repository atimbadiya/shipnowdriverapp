...
class CameraViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        AppConstants.meterimagevelue = "1"
        ...
        AppConstants.imagearray.append(imageData!)
        AppConstants.imagestring.append(" send_meter_image")
    ...
    @IBAction func okbtnclick(_ sender: Any) {
        ...
        AppConstants.meterreadingvalue = entermetervalue.text!
        
        
        if AppConstants.meterimagevelue == ""{
        ...
        } else  if AppConstants.meterreadingvalue.isEqual(""){
            ...
            AppConstants.checkfromcamera = 1
            AppConstants.meterimagevelue = ""
            self.dismissVC()
