...
public struct AccessTokenData: Mappable {
  ...
  private struct SerializationKeys {
    ...
    static let taxicompany = "taxi_company"
  ...
  public var accessToken: String?
   public var taxicompany: Bool? = false
  ...
  public mutating func mapping(map: Map) {
    ...
    taxicompany <- map[SerializationKeys.taxicompany]
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    dictionary[SerializationKeys.taxicompany] = taxicompany
