...
public struct ActiveRideData: Mappable {
  ...
  private struct SerializationKeys {
        ...
        static let order_position = "order_position"
  }
  ...
  public mutating func mapping(map: Map) {
    ...
    statusTextSyle <- map[SerializationKeys.statusTextSyle]
      ...
      order_position <- map[SerializationKeys.order_position]
  }
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = statusTextSyle { dictionary[SerializationKeys.statusTextSyle] = value }
      ...
      if let value = order_position { dictionary[SerializationKeys.order_position] = value }
