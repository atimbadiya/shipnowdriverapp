//
//  CorporateBookingData.swift
//  ApporioTaxiDriver
//
//  Created by Ankit's Mac on 15/6/21.
...
public struct CorporateBookingData: Mappable {
    ...
    public var product_list : [ProductListDetails]?
    ...
    public mutating func mapping(map: Map) {
        ...
        product_list <- map[SerializationKeys.product_list]
    }
    ...
    public func dictionaryRepresentation() -> [String: Any] {
      var dictionary: [String: Any] = [:]
        ...
        if let value = product_list { dictionary[SerializationKeys.product_list] = value.map { $0.dictionaryRepresentation() } }
