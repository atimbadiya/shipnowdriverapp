...
public struct DriverBookingDetailoneLocation: Mappable {
  ...
  private struct SerializationKeys {
    ...
    static let locationMessage = "location_message"
  }
  ...
  public mutating func mapping(map: Map) {
    ...
    locationMessage <- map[SerializationKeys.locationMessage]
  }
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = locationMessage { dictionary[SerializationKeys.locationMessage] = value }
    return dictionary
  }
