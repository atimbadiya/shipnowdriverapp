...
public struct DriverCancelRideData: Mappable {
  ...
  private struct SerializationKeys {
    ...
    static let cancelReasonId = "cancel_reason_id"
  ...
  public var cancelReasonId: String?
  ...
  public mutating func mapping(map: Map) {
    ...
    cancelReasonId <- map[SerializationKeys.cancelReasonId]
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = cancelReasonId { dictionary[SerializationKeys.cancelReasonId] = value }
