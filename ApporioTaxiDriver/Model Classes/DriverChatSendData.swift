...
public struct DriverChatSendData: Mappable {
  ...
  // MARK: Properties
  public var chat: DriverChatSendChat?
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = chat { dictionary[SerializationKeys.chat] = value.dictionaryRepresentation() }
