...
extension JLStickerImageView {
    ...
    public func addLabel(text: String) {
        ...
        let labelFrame = CGRect(x: 5,
                                    y: self.bounds.height/2 - 10,
                                    width: self.bounds.width-10, height: 3)
...
//        labelView.borderColor = UIColor.white
        labelView.labelTextView?.fontSize = 2
        labelView.labelTextView?.textContainer.maximumNumberOfLines = 2
